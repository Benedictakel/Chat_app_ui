            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const Spacer(),
                  Image.asset(
                    "assets/images/search.png", // Corrected path
                    height: 40,
                  ),
                  const SizedBox(
                    width: 15,
                  ...
                  const CircleAvatar(
                    backgroundImage: AssetImage(
                        "assets/images/profile.png"), // Corrected path
                  )
                ],
              ),
              ...
              // for chat user list, wrap it in Expanded to prevent overflow
              Expanded(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              // Added Expanded to handle overflow
                              child: Column(
        ...
        child: Row(
          ...
          children: [
            Column(
              children: [
                Image.asset(
                  "assets/images/chat.png", // Corrected path
                  height: 50,
                ),
                Text(
                  "Chats",
            ...
            Column(
              children: [
                Image.asset(
                  "assets/images/call_icon.png", // Corrected path
                  height: 50,
                ),
                Text(
                  "Calls",
            ...
            Column(
              children: [
                Image.asset(
                  "assets/images/group.png", // Corrected path
                  height: 50,
                ),
                Text(
                  "Contacts",
